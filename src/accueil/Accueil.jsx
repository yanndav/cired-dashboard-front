  ...
  return (
    <>
      ...
      <ContainerAccueil>
        ...
        <FlexContainer full>
          <Section limitWidth ref={refEquipe}>
            <SousTitrePage>
              <AnimatedTextHighlight>
                L'équipe de comparater
              </AnimatedTextHighlight>
            </SousTitrePage>
            <Argument bottomSpace>
              <ZoneTexte>
                Notre équipe est petite, mais{" "}
                <AnimatedTextHighlight tertiary>
                  déterminée à contribuer au pilotage de la transition
                  écologique des territoires
                </AnimatedTextHighlight>
                . Nous combinons nos expériences et nos expertises
                méthodologiques complémentaires pour assurer la rigueur
                scientifique et la pertinence du contenu de comparater.
              </ZoneTexte>
            </Argument>
          </Section>
          <FlexContainer row big>
            <Argument column shrink>
              ...
              <ZoneTexte noBasis>
                Gilles Crague est ingénieur et sociologue habilité à diriger des
                recherches‚ directeur de recherche à l’École des Ponts
                ParisTech. Fort de multiples expériences de recherche- action
                auprès de décideurs locaux à différentes échelles, il dispose
                d'une profonde compréhension des enjeux territoriaux de la
                transition écologique.
              </ZoneTexte>

              <ZoneTexte noBasis>
                Il est garant de la rigueur méthodologique de comparater, qui
                adopte la perspective multiniveaux, et supervise le déploiement
                d'analyses.
              </ZoneTexte>
              <Emphase>
                <Lien href="mailto:gilles.crague@enpc.fr" target="_blank">
                  gilles.crague@enpc.fr
                </Lien>
              </Emphase>
            </Argument>
            <Argument column shrink>
              ...
              <ZoneTexte noBasis>
                Yann David est double diplômé en politiques publiques et en
                économie appliquée. Ce parcours académique lui permet de
                maitriser et de suivre l'évolution des méthodes avancées
                d'analyse de données, tout en conservant un intérêt majeur pour
                leur application dans l'aide à la décision publique. Pour
                compléter sa formation, il s'est formé au développement web.
              </ZoneTexte>

              <ZoneTexte noBasis>
                Il est responsable de la planification et de la construction des
                composants de comparater, ainsi que de l'intégration des
                données.
              </ZoneTexte>
              <Emphase>
                <Lien href="mailto:yann.david@enpc.fr" target="_blank">
