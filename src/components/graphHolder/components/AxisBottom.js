...
const AxisBottomCategorical = ({xScale,innerHeight,innerWidth,xVariable}) => 
<>
...
const AxisBottomContinuous = ({xScale,innerHeight,innerWidth,xVariable}) => 
<>
{xScale.ticks(10).map(tickValue =>
    <g key={tickValue} transform={`translate(${xScale(tickValue)},${innerHeight+10})`}>
        <line className="tick"
        y1={-innerHeight-10}
        y2={-10}
        />
